...
Layout limpo, visual profissional e fácil de adaptar para diferentes tipos de negócio.
...
```bash
git clone https://github.com/seu-usuario/Site-Vendas-Modelo.git
cd Site-Vendas-Modelo
npm install
npm run dev
